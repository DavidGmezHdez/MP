...
int main() {
    ...
    obtenerMayorSecuenciaMonotonaCreciente(array1, utilArray, secuenciaCreciente, utilSecuenciaCreciente);
    ...
    obtenerMayorSecuenciaMonotonaCreciente(array2, utilArray, secuenciaCreciente, utilSecuenciaCreciente);
    imprimirArray(secuenciaCreciente, utilSecuenciaCreciente);
    cout << "--------------------------------------------------------------------\n";
    ...
    obtenerMayorSecuenciaMonotonaCreciente(array3, utilArray, secuenciaCreciente, utilSecuenciaCreciente);
    imprimirArray(secuenciaCreciente, utilSecuenciaCreciente);
    cout << "--------------------------------------------------------------------\n";
    ...
    obtenerMayorSecuenciaMonotonaCreciente(array4, utilArray, secuenciaCreciente,utilSecuenciaCreciente);
    imprimirArray(secuenciaCreciente, utilSecuenciaCreciente);
    cout << "--------------------------------------------------------------------\n";
    ...
    obtenerMayorSecuenciaMonotonaCreciente(array5, utilArray, secuenciaCreciente,utilSecuenciaCreciente);
    imprimirArray(secuenciaCreciente, utilSecuenciaCreciente);
    cout << "--------------------------------------------------------------------\n";
}
