...
int main() {
    ...
    cout << "---------------------------------------------\n";
    int tam12 = mezclar(array1, 4, array2, 4, array12, 20);
    ...
    cout << "---------------------------------------------\n";
    int tam34 = mezclar(array3, 3, array4, 5, array34, 20);
    ...
    cout << "---------------------------------------------\n";
    int tam56 = mezclar(array5, 5, array6, 3, array56, 20);
