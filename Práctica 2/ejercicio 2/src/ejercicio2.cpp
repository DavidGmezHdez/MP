...
int main() {
    ...
    int util1=combinarSuma(array1, 5, array2, 5, resultado1,10);
    ...
    int util2=combinarSuma(array3, 4, array4, 5, resultado2,10);
    ...
    // Se llama al metodo de combinacion
    int util3=combinarSuma(array5, 5, array6, 3, resultado3,10);
