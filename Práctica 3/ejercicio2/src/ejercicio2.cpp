...
int main() {
    ...
    // Caso 1
    const Valor array1[]={Valor(1, 1, 0.7), Valor(1, 3, 9.4), Valor(2, 1, 8.3), Valor(3, 1, 6.45),
                    Valor(3, 3, 2.75)};
    const Valor array2[]={Valor(0, 0, 10), Valor(1, 1, 0.3), Valor(1, 2, 4.3), Valor(2, 2, 1.5), Valor(3, 2, 0.25)};
    Valor resultado1[10];
